...
namespace Edtech.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseTitle,InstructorName,Description,Duration,Price,ProfileImage,ProfileVideo1,ProfileVideo2,ProfileVideo3,ProfileVideo4,ProfileVideo5")] Student2 student2, string originalProfileImage, string originalProfileVideo1, string originalProfileVideo2, string originalProfileVideo3, string originalProfileVideo4, string originalProfileVideo5)
        {
            if (id != student2.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    // Check if each ProfileVideo is not modified, use the original value
                    if (string.IsNullOrEmpty(student2.ProfileVideo1))
                    {
                        student2.ProfileVideo1 = originalProfileVideo1;
                    }
                    if (string.IsNullOrEmpty(student2.ProfileVideo2))
                    {
                        student2.ProfileVideo2 = originalProfileVideo2;
                    }
                    if (string.IsNullOrEmpty(student2.ProfileVideo3))
                    {
                        student2.ProfileVideo3 = originalProfileVideo3;
                    }
                    if (string.IsNullOrEmpty(student2.ProfileVideo4))
                    {
                        student2.ProfileVideo4 = originalProfileVideo4;
                    }
                    if (string.IsNullOrEmpty(student2.ProfileVideo5))
                    {
                        student2.ProfileVideo5 = originalProfileVideo5;
                    }
